...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample :-\n<code>/{BotCommands.WatchCommand} https://youtu.be/Pk_TthHfLeE 720 |New Name</code>\n\n"
        msg += "This File Will Be Downloaded In <b>720p Quality</b> & It's Name Will Be <b>New Name</b> !👍"
